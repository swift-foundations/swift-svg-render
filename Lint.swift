...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-svg-render open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-svg-render project authors
